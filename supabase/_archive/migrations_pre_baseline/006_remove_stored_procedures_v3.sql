-- ============================================================================
-- Migration: Remove Stored Procedures and Simplify RLS (v3 - Fixed Order)
...
-- ============================================================================
-- STEP 1: Drop all RLS policies FIRST (before dropping functions they depend on)
-- ============================================================================
...
DROP POLICY IF EXISTS "Team captains can create teams" ON teams;
...
DROP POLICY IF EXISTS "Team members are viewable by team members and challenge partici" ON team_members;
...
DROP POLICY IF EXISTS "Team captains can update team members" ON team_members;
...
DROP POLICY IF EXISTS "Participants are viewable by challenge members" ON challenge_participants;
...
DROP POLICY IF EXISTS "Check-ins are viewable by challenge participants" ON check_ins;
...
-- COMMENTS POLICIES (if they exist)
DROP POLICY IF EXISTS "Comments are viewable by relevant users" ON comments;
...
-- LEADERBOARD POLICIES (if they exist)
DROP POLICY IF EXISTS "Leaderboard is viewable by challenge participants" ON leaderboard;
...
-- ACHIEVEMENTS POLICIES (if they exist)
...
-- REACTIONS POLICIES (if they exist)
DROP POLICY IF EXISTS "Users can view reactions" ON reactions;
DROP POLICY IF EXISTS "Reactions are viewable by relevant users" ON reactions;
...
-- PAYMENTS POLICIES (if they exist)
DROP POLICY IF EXISTS "Users can view their own payments" ON payments;

-- ============================================================================
-- STEP 2: Now drop functions (after policies are removed)
-- ============================================================================
...
-- ============================================================================
-- LEADERBOARD POLICIES (simplified - read-only for participants)
-- ============================================================================
