...
-- ============================================================================
-- MERGED FROM former 043100/043a seed file (2026-06-01)
-- Reason: unique-integer-version rule; seed must run after the table it fills,
-- in the same migration version. Appended here so table+seed share version 043.
-- ============================================================================
