 ...
 *
 * Each milestone tier gets its own lucide glyph and gradient:
 *
 *   -   7  "7-Day Warrior"       Flame   orange → amber
 *   -  30  "Monthly Master"      Medal   indigo → cyan
 *   -  60  "60-Day Champion"     Trophy  purple → fuchsia
 *   - 100  "Centurion"           Crown   gold → yellow
 *   - 365  "Year of Excellence"  Star    cyan → purple → orange
 *
...
import { Crown, Flame, Medal, Star, Trophy, type LucideIcon } from 'lucide-react';
...
const MILESTONE_STYLES: Record<number, MilestoneStyle> = {
  7:   { icon: Flame,  colors: ['#f97316', '#fbbf24'] },
  30:  { icon: Medal,  colors: ['#6366f1', '#06b6d4'] },
  60:  { icon: Trophy, colors: ['#8b5cf6', '#d946ef'] },
  100: { icon: Crown,  colors: ['#f59e0b', '#fde047'] },
  365: { icon: Star,   colors: ['#06b6d4', '#8b5cf6', '#f97316'] },
};
