  ...
  try {
    ...
    const validInvites = (invites || [])
      ...
      .map((invite) => ({
        ...
        circle_name: (invite.fitcircles as any)?.[0]?.name,
        circle_description: (invite.fitcircles as any)?.[0]?.description,
        start_date: (invite.fitcircles as any)?.[0]?.start_date,
        end_date: (invite.fitcircles as any)?.[0]?.end_date,
        member_count: (invite.fitcircles as any)?.[0]?.participant_count || 0,
