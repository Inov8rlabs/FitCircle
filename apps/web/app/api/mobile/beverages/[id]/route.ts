/**
 * Individual Beverage Log Entry API Routes
 * GET /api/mobile/beverages/[id] - Get single entry
 * PATCH /api/mobile/beverages/[id] - Update entry
 * DELETE /api/mobile/beverages/[id] - Delete entry
 */
...
export async function GET(
  ...
  try {
    ...
    // Get entry
    const entryResult = await BeverageLogService.getEntryById(entryId, user.id, supabase);
    ...
    console.error('[Mobile API] Get beverage log entry error:', {
...
export async function PATCH(
  ...
  try {
    ...
    console.error('[Mobile API] Update beverage log entry error:', {
      message: error.message,
    });
 ...
 * Delete beverage log entry (soft delete)
 */
export async function DELETE(
  ...
  try {
    ...
    // Delete entry
    const result = await BeverageLogService.deleteEntry(entryId, user.id, supabase);
    ...
    console.error('[Mobile API] Delete beverage log entry error:', {
      message: error.message,
    });
